...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-05-2023 a las 17:04:56
...
(1, 'NULL', '45', '*descripcion.h', 1),
(2, 'NULL', '40', '*descripcion.h', 1),
(3, 'NULL', '35', '*descripcion.h', 2),
(4, 'NULL', '30', '*descripcion.h', 2),
(5, 'NULL', '25', '*descripcion.h', 1);
...
(2, 'Naucalpan de Juarez', 5),
(3, 'Naucalpan de Juarez', 2),
...
INSERT INTO `plantel` (`Id_Plantel`, `Nombre_p`, `Calle`, `Colonia`, `Telefono_p`, `Correoelectronico_p`, `Clave`, `Id_Municipio`) VALUES
(1, 'Conalep1', 'valle dorado1', '', '5530324541', 'conalepmex.edu1', '2021', 0),
(2, 'Conalep2', 'valle dorado2', '', '5530324542', 'conalepmex.edu2', '2021', 0),
(3, 'Conalep3', 'valle dorado3', '', '5530324543', 'conalepmex.edu3', '2021', 0),
(4, 'Conalep4', 'valle dorado4', '', '5530324544', 'conalepmex.edu4', '2021', 0),
(5, 'Conalep5', 'valle dorado5', '', '5530324545', 'conalepmex.edu5', '2021', 0);
...
(1, 'Victor', 'Guztavo', 'Garcia', '5527283131', 'yootu0@gmail', 'bebe', 1, 5),
(2, 'Luis', 'Hernandez', 'Valencia', '5527245451', 'yootu1@gmail', 'coca', 2, 4),
(3, 'Francisco', 'Galvez', 'Lopez', '5527284544', 'yootu2@gmail', 'perico', 3, 2),
(4, 'Paola', 'Ventura', 'Flores', '5546283131', 'yootu3@gmail', 'pepe', 4, 1),
(5, 'Garcia', 'De la Cruz', 'Bautista', '5587283131', 'yootu4@gmail', 'chabelo', 5, 3);
...
--
ALTER TABLE `inventario`
  ADD CONSTRAINT `inventario_ibfk_1` FOREIGN KEY (`Id_Laboratorio`) REFERENCES `laboratorio` (`Id_Laboratorio`);
...
ALTER TABLE `usuario`
  ...
  ADD CONSTRAINT `usuario_ibfk_2` FOREIGN KEY (`Id_Plantel`) REFERENCES `plantel` (`Id_Plantel`);
COMMIT;
