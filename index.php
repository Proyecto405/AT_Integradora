        ...
        <div class="col-md-10 col-lg-6 px-2 mt-3">
            ...
            <div class="row mt-1 text-center">
                <div class="col container ">
                    <img src="img/cherry.png" alt="logoCherryTreeSoftware" style="width: 200px;" class="img-fluid" id="img1">
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-sm-6 col-md-6 col-lg-6 text-center mt-4"><span class="text-success text-wrap fs-6">AdminCherry's|cherrytreesoftware33@gmail.com </span></div>
            </div>
            <!-- ayuda -->
